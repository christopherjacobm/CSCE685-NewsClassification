...
from keras.layers import LSTM, Input, Embedding, Dense, Dropout, GlobalMaxPool1D, Activation, Flatten, Bidirectional, GRU
...
def getModel(max_len, max_features):
    ...
    # GRU layer, nodes = 80
    x = Bidirectional(GRU(80, return_sequences=True, name='LSTM_layer'))(x)     
